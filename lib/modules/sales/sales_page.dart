...
Future<void> _openSaleForm(
  ...
  void showWarning(String text) {
    ...
    void addItem({InventoryItemModel? stockItem}) async {
    final nameCtrl = TextEditingController(text: stockItem?.name ?? '');
    final qtyCtrl = TextEditingController(text: '1');
    final double defaultPrice = stockItem?.sellPrice ?? stockItem?.avgCost ?? 0;
    final priceCtrl = TextEditingController(
      text: defaultPrice > 0 ? moneyFormatter.format(defaultPrice) : '',
    );
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(value: 'service', child: Text('Servi?o')),
                ...
                SwitchListTile.adaptive(
                  ...
                  contentPadding: EdgeInsets.zero,
                  onChanged: (value) => setState(() => requiresInstallation = value),
                  title: const Text('Requer instala??o'),
                ),
                const SizedBox(height: 16),
                SizedBox(
                  width: double.infinity,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      if (autoOrderValue) {
                        ...
                        orderMeta = await _openOrderMetaModal(sheetCtx, controller);
...
Future<Map<String, dynamic>?> _openOrderMetaModal(
  BuildContext context,
  SalesController controller,
) async {
  final roomCtrl = TextEditingController();
  final notesCtrl = TextEditingController();
  final techId = RxnString();
  DateTime? scheduledAt;
  final techs = await controller.ensureTechniciansLoaded();
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: techs
                      ...
                      .toList(),
                  onChanged: (value) => techId.value = value,
                ),
                const SizedBox(height: 8),
                TextField(
                  controller: roomCtrl,
                  decoration: const InputDecoration(
                    labelText: 'C?modo/ambiente',
                    hintText: 'Ex.: Sala, Quarto, Escrit?rio',
                  ),
                ),
                const SizedBox(height: 8),
                Align(
                ...
                TextField(
                  ...
                  maxLines: 2,
                  decoration: const InputDecoration(
                    labelText: 'Observa??es da OS (opcional)',
                  ),
                ),
                const SizedBox(height: 16),
                SizedBox(
