...
class LoginController extends GetxController with MessagesMixin, LoaderMixin {
  ...
  Future<void> login() async {
    ...
    try {
      ...
      await _storage.setSuspendedFlag(false);
      ...
      final msg = _apiError(e, 'Falha ao fazer login.');
      if (code == 'ACCOUNT_SUSPENDED') {
        if (_suspendedHandled) return;
        _suspendedHandled = true;
        _ensureSubscriptionsController();
        await _storage.setSuspendedFlag(true);
        message(
          MessageModel.info(
            title: 'Conta suspensa',
            message: '$msg Vá para Faturas e regularize o pagamento.',
          ),
        );
        // Redireciona apenas para billing/faturas em modo restrito.
        Get.offAll(
...
Future<void> resetPassword(String email) async {
    ...
    try {
      ...
      message(
        ...
        MessageModel.error(
          ...
          message: 'NÃÂ£o foi possÃÂ­vel fazer logout. Tente novamente!',
    ...
    try {
      ...
      message(
        ...
        MessageModel.error(
          ...
          title: 'NÃÂ£o foi possÃÂ­vel concluir o cadastro',
    ...
    if (!biometricEnabled.value || !canUseBiometrics.value) {
      ...
      message(
        ...
        MessageModel.error(
          ...
          message: 'Ative a biometria apÃÂ³s um login bem-sucedido.',
    ...
    if (creds == null) {
      ...
      message(
        ...
        MessageModel.error(
          ...
          message: 'NÃÂ£o encontramos credenciais salvas. FaÃÂ§a login e ative novamente.',
    ...
    try {
      ...
      message(
        ...
        MessageModel.error(
          ...
          message: 'NÃÂ£o foi possÃÂ­vel autenticar via biometria.',
  ...
  Future<void> _maybeShowTrialGrace(UserModel user) async {
    ...
    message(
      ...
      MessageModel.info(
        ...
        title: 'CarÃÂªncia inicial (teste)',

        message:

            'Aviso: sua fatura inicial tem $_trialGraceDays dias de carÃÂªncia. VocÃÂª pode pagar agora ou atÃÂ© $formatted sem cobranÃÂ§a extra.',
  ...
  Future<bool> _requireActivationCode(UserModel user) async {
    ...
    if (!pending) {
      ...
      // Se nÃÂ£o marcamos como pendente (ex: conta antiga), nÃÂ£o exigimos.
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                'Enviamos um SMS com seu cÃÂ³digo de ativaÃÂ§ÃÂ£o. Digite abaixo para liberar o primeiro acesso.',
              ...
              TextButton.icon(
                ...
                label: const Text(
                  ...
                  'Puxar cÃÂ³digo do SMS automaticamente',
                ...
                onPressed: () {
                  ...
                  if (code.length < 4 || code.length > 6) {
                    ...
                    Get.snackbar(
                      ...
                      'CÃÂ³digo invÃÂ¡lido',

                      'Informe o cÃÂ³digo de 4 a 6 dÃÂ­gitos enviado por SMS.',
...
String _apiError(DioException error, String fallback) {
  ...
  // Backend padrão: { error: { code, message, details, requestId } }
  if (data is Map) {
    final nestedError = data['error'];
    if (nestedError is Map && nestedError['message'] is String) {
      final msg = (nestedError['message'] as String).trim();
  ...
  // Evita expor a mensagem genérica do Dio; usa fallback amigável.
  return fallback;
}
...
String? _apiErrorCode(DioException error) {
  ...
  if (data is Map) {
    final nestedError = data['error'];
    if (nestedError is Map && nestedError['code'] is String) {
      final code = (nestedError['code'] as String).trim();
...
void _ensureSubscriptionsController() {
