...
class ClientRepositoryImpl implements ClientRepository {
  ...
  ClientModel _mapSingle(dynamic source) {
    ...
    throw ClientFailure.unknown('Resposta de cliente invÃÂ¡lida');
  ...
  Never _handleDio(DioException error, {required String fallback}) {
    ...
    if (status == 404) {
      ...
      throw ClientFailure.validation(
        ...
        message.isEmpty ? 'Cliente nÃÂ£o encontrado' : message,
  ...
  Future<ClientModel> create(ClientModel client) async {
    ...
    if (client.name.trim().isEmpty) {
      ...
      throw ClientFailure.validation('Nome do cliente ÃÂ© obrigatÃÂ³rio');
  ...
  Future<ClientModel> update(
    ...
    if (client.id.isEmpty) {
      ...
      throw ClientFailure.validation(
        ...
        'ID do cliente ÃÂ© obrigatÃÂ³rio para atualizaÃÂ§ÃÂ£o',
