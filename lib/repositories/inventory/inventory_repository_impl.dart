...
class InventoryRepositoryImpl implements InventoryRepository {
  ...
  Future<List<InventoryItemModel>> getItems({
    ...
    try {
      ...
      // Evita derrubar a tela por erro de parsing/validaÃ§Ã£o.
  ...
  Future<InventoryItemModel> registerItem({
    ...
    if (trimmedName.isEmpty) {
      throw InventoryFailure.validation('Nome Ã© obrigatÃ³rio');
    }
    if (minQty < 0) {
      throw InventoryFailure.validation('Estoque mÃ­nimo invÃ¡lido');
    }
  ...
  Future<void> updateItem(InventoryItemModel item) async {
    ...
    if (item.id.isEmpty) {
      ...
      throw InventoryFailure.validation(
        ...
        'ID do item Ã© obrigatÃ³rio para atualizaÃ§Ã£o',
    ...
    try {
      ...
      if (itemId.isEmpty) {
        ...
        throw InventoryFailure.validation(
          ...
          'ID do item Ã© obrigatÃ³rio para exclusÃ£o',
  ...
  Future<List<StockMovementModel>> listMovements({
    ...
    try {
      ...
      final message = _extractErrorMessage(
        ...
        'Erro ao buscar histÃ³rico de movimentos',
  ...
  Future<void> transferStock({
    ...
    try {
      ...
      throw InventoryFailure.unknown('Erro inesperado na transferÃªncia');
  ...
  Future<List<InventoryCostHistoryEntry>> getCostHistory(String id) async {
    try {
      ...
      final message = _extractErrorMessage(
        e,
        'Erro ao buscar histÃ³rico de custo',
      );
